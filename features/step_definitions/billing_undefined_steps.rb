...
Given("a claim submission exists with Clearinghouse ID {string}") do |clearinghouse_id|
  @claim_submission = Corvid::ClaimSubmission.create!(
    tenant_identifier: @tenant, facility_identifier: @facility,
    patient_identifier: "pt_billing_001",
    claim_identifier: clearinghouse_id,
...
Given("a claim exists with Clearinghouse ID {string}") do |clearinghouse_id|
  @claim_submission = Corvid::ClaimSubmission.create!(
    tenant_identifier: @tenant, facility_identifier: @facility,
    patient_identifier: "pt_billing_001",
    claim_identifier: clearinghouse_id,
...
Given("a claim exists with Clearinghouse ID {string} and billed amount {string}") do |clearinghouse_id, amount|
  @claim_submission = Corvid::ClaimSubmission.create!(
    tenant_identifier: @tenant, facility_identifier: @facility,
    patient_identifier: "pt_billing_001",
    claim_identifier: clearinghouse_id,
...
Then("I should see the current status from Clearinghouse") do
...
Then("each claim should be checked with Clearinghouse") do
...
Given("the Clearinghouse API returns an error for the second claim") do
  @api_error_flag = true
end
...
Given("the Clearinghouse API times out") do
