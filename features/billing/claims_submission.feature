...
Feature: Clearinghouse Claims Submission
  As a billing coordinator
  I want to submit claims electronically via Clearinghouse
  ...
  Scenario: Submit a professional claim for a completed service request
    ...
    And I should see a Clearinghouse claim ID
  ...
  Scenario: View claim submission status
    ...
    Then I should see the Clearinghouse claim ID
  ...
  Scenario: Submit multiple claims in batch
    ...
    And each claim should have a unique Clearinghouse claim ID
