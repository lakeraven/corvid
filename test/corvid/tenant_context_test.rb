...
class Corvid::TenantContextTest < Minitest::Test
  ...
  def test_current_tenant_identifier_can_be_set
    ...
    assert_equal "tnt_example", Corvid::TenantContext.current_tenant_identifier
  end

  def test_current_facility_identifier_can_be_set
    Corvid::TenantContext.current_facility_identifier = "fac_example"
    assert_equal "fac_example", Corvid::TenantContext.current_facility_identifier
  end
  ...
  def test_require_tenant_returns_current_when_set
    Corvid::TenantContext.current_tenant_identifier = "tnt_example"
    assert_equal "tnt_example", Corvid::TenantContext.require_tenant!
  end
